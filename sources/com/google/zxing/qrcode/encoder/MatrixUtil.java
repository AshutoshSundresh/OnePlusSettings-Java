...
public final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, R$styleable.Constraint_layout_goneMarginStart, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, R$styleable.Constraint_visibilityMode, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, androidx.appcompat.R$styleable.AppCompatTheme_windowActionBarOverlay, -1, -1}, new int[]{6, 26, 50, 74, 98, androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMajor, -1}, new int[]{6, 30, 54, 78, R$styleable.Constraint_layout_goneMarginStart, androidx.appcompat.R$styleable.AppCompatTheme_windowNoTitle, -1}, new int[]{6, 26, 52, 78, R$styleable.Constraint_motionStagger, 130, -1}, new int[]{6, 30, 56, 82, R$styleable.Constraint_transitionEasing, 134, -1}, new int[]{6, 34, 60, 86, 112, 138, -1}, new int[]{6, 30, 58, 86, 114, 142, -1}, new int[]{6, 34, 62, 90, androidx.appcompat.R$styleable.AppCompatTheme_windowActionBarOverlay, 146, -1}, new int[]{6, 30, 54, 78, R$styleable.Constraint_layout_goneMarginStart, androidx.appcompat.R$styleable.AppCompatTheme_windowNoTitle, 150}, new int[]{6, 24, 50, 76, R$styleable.Constraint_layout_goneMarginStart, 128, 154}, new int[]{6, 28, 54, 80, 106, 132, 158}, new int[]{6, 32, 58, 84, R$styleable.Constraint_visibilityMode, 136, 162}, new int[]{6, 26, 54, 82, R$styleable.Constraint_visibilityMode, 138, 166}, new int[]{6, 30, 58, 86, 114, 142, 170}};
