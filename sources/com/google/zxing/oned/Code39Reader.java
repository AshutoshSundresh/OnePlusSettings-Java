...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, UseOpenWifiPreferenceController.REQUEST_CODE_OPEN_WIFI_AUTOMATICALLY, 208, 133, 388, 196, 148, 168, 162, 138, 42};
                ...
                if (patternToChar == '*') {
                    ...
                    if (nextSet2 == size || (i6 >> 1) >= i4) {
                        ...
                        if (sb.length() != 0) {
                            ...
                            float f = (float) i;
                            return new Result(str, null, new ResultPoint[]{new ResultPoint(((float) (findAsteriskPattern[1] + findAsteriskPattern[0])) / 2.0f, f), new ResultPoint(((float) (nextSet2 + nextSet)) / 2.0f, f)}, BarcodeFormat.CODE_39);
                        }
