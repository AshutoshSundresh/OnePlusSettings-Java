            ...
            if (pattern >= 0) {
                ...
                if (patternToChar == '*') {
                    ...
                    if (nextSet2 == size || !bitArray.get(nextSet2)) {
                        ...
                        float f = (float) i;
                        return new Result(decodeExtended(sb), null, new ResultPoint[]{new ResultPoint(((float) (findAsteriskPattern[1] + findAsteriskPattern[0])) / 2.0f, f), new ResultPoint(((float) (nextSet2 + nextSet)) / 2.0f, f)}, BarcodeFormat.CODE_93);
                    } else {
                        throw NotFoundException.getNotFoundInstance();
                    }
                } else {
