...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        setBackgroundDrawable(getResources().getDrawable(R$drawable.op_input_edit_text_material));
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout textInputLayout) {
        ...
        sb.append((!z3 || TextUtils.isEmpty(charSequence)) ? str : ", ");
