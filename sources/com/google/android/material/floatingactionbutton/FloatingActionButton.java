...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public void hideWithAnim() {
        if (this.mScrollHide) {
            animate().scaleX(0.6f).scaleY(0.6f).alpha(0.0f).setDuration(150).setListener(new Animator.AnimatorListener() {
    ...
    public void showWithAnim() {
        if (this.mScrollHide) {
            animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(150).setListener(new Animator.AnimatorListener() {
                /* class com.google.android.material.floatingactionbutton.FloatingActionButton.AnonymousClass2 */
    ...
    private FloatingActionButtonImpl.InternalVisibilityChangedListener wrapOnVisibilityChangedListener(final OnVisibilityChangedListener onVisibilityChangedListener) {
        ...
        return new FloatingActionButtonImpl.InternalVisibilityChangedListener() {
            /* class com.google.android.material.floatingactionbutton.FloatingActionButton.AnonymousClass3 */
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i != 1) {
                return resources.getDimensionPixelSize(R$dimen.op_control_avatar_size2);
            }
