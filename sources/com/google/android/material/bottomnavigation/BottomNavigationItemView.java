...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.baselineLayout = (BaselineLayout) findViewById(R$id.baseline);
        ...
        BaselineLayout baselineLayout2 = this.baselineLayout;
        if (baselineLayout2 != null) {
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) baselineLayout2.getLayoutParams();
            layoutParams.bottomMargin = (int) ViewUtils.dpToPx(getContext(), 13);
            this.baselineLayout.setLayoutParams(layoutParams);
        }
    }
