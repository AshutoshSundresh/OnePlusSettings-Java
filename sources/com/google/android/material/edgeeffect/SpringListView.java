...
public class SpringListView extends ListView {
    ...
    private boolean mSkipSpringAnimationOnce = false;
    ...
    private void pullGlows(float r6, float r7, float r8, float r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.edgeeffect.SpringListView.pullGlows(float, float, float, float):void");
    }
        ...
        public void onScroll(AbsListView absListView, int i, int i2, int i3) {
            ...
            if (i4 == 2 || i4 == 1) {
                if (!SpringListView.this.canScrollVertically(-1) && !SpringListView.this.mGlowing) {
                    float f = SpringListView.this.mLastYVel;
                    if (f >= 0.0f) {
                        f = SpringListView.this.computeVelocity();
                    }
                    ...
                    float f2 = f / 20.0f;
                    springListView.pullGlows(springListView.mLastX, 0.0f, SpringListView.this.mLastY, f2);
                    if (SpringListView.this.mTopGlow != null) {
                        SpringListView.this.mTopGlow.onAbsorb((int) f2);
                    }
                }
                if (!SpringListView.this.canScrollVertically(1) && !SpringListView.this.mGlowing) {
                    float f3 = SpringListView.this.mLastYVel;
                    if (f3 <= 0.0f) {
                        f3 = SpringListView.this.computeVelocity();
                    }
                    if (SpringListView.this.mSpringListener != null) {
                    ...
                    float f4 = f3 / 20.0f;
                    springListView2.pullGlows(springListView2.mLastX, 0.0f, SpringListView.this.mLastY, f4);
                    if (SpringListView.this.mBottomGlow != null) {
                        SpringListView.this.mBottomGlow.onAbsorb((int) f4);
                    }
                }
            }
        }
