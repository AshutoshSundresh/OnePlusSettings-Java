...
public class SpringScrollView extends ScrollView {
    ...
    private void pullGlows(float r6, float r7, float r8, float r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.edgeeffect.SpringScrollView.pullGlows(float, float, float, float):void");
    }
