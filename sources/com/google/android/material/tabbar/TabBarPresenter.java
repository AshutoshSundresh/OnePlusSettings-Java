...
public class TabBarPresenter implements MenuPresenter {
    private int id;
    ...
    public void setTabBarMenuView(TabBarMenuView tabBarMenuView) {
    ...
    public void updateMenuView(boolean z) {
        if (!this.updateSuspended) {
            if (z) {
                this.menuView.buildMenuView(true);
            } else {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class com.google.android.material.tabbar.TabBarPresenter.SavedState.AnonymousClass1 */
