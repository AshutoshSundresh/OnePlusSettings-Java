...
public class OPAppLinearLayoutManager extends LinearLayoutManager {
    ...
    public OPAppLinearLayoutManager(Context context, OPAppDragAndDropAdapter oPAppDragAndDropAdapter) {
        super(context);
        this.mContext = context;
        this.mAdapter = oPAppDragAndDropAdapter;
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        sb.append(i);
        sb.append(", ");
        sb.append((Object) ((OPAppDragCell) view).getCheckbox().getContentDescription());
    ...
    public boolean performAccessibilityActionForItem(androidx.recyclerview.widget.RecyclerView.Recycler r6, androidx.recyclerview.widget.RecyclerView.State r7, android.view.View r8, int r9, android.os.Bundle r10) {
        /*
            ...
            com.oneplus.settings.quicklaunch.OPAppDragAndDropAdapter r6 = r5.mAdapter
            int r7 = r1 + -1
            r6.onItemMove(r1, r7)
        L_0x0017:
            r3 = r4
        ...
        L_0x0019:
            ...
            com.oneplus.settings.quicklaunch.OPAppDragAndDropAdapter r7 = r5.mAdapter
            r7.onItemMove(r1, r6)
            goto L_0x0017
        L_0x0027:
        ...
        L_0x004c:
            ...
            com.oneplus.settings.quicklaunch.OPAppDragAndDropAdapter r5 = r5.mAdapter
            r5.doTheUpdate()
        L_0x0053:
            return r3
        L_0x0054:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.settings.quicklaunch.OPAppLinearLayoutManager.performAccessibilityActionForItem(androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State, android.view.View, int, android.os.Bundle):boolean");
    }
}
