...
public class TabUtils {
    ...
    public static void setupWithViewPager(TabLayout tabLayout, ViewPager viewPager, OnSetupTabListener onSetupTabListener) {
        int currentItem;
        PagerAdapter adapter = viewPager.getAdapter();
        if (adapter != null) {
            setTabsFromPagerAdapter(tabLayout, adapter, onSetupTabListener);
            viewPager.addOnPageChangeListener(new TabLayoutOnPageChangeListener(tabLayout));
            tabLayout.setOnTabSelectedListener((TabLayout.OnTabSelectedListener) new ViewPagerOnTabSelectedListener(viewPager));
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f, int i2) {
            ...
            if (tabLayout != null) {
                ...
                if (this.mScrollState == 0 && (i3 = this.mPendingSelection) != -1) {
