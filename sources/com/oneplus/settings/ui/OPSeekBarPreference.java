...
public class OPSeekBarPreference extends Preference {
    ...
    public OPSeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C0012R$layout.op_seekpreference);
    }
    ...
    private void initSeekBar(PreferenceViewHolder preferenceViewHolder) {
        ...
        seekBar.setMax(100);
        this.mSeekBar.setProgress(Settings.System.getInt(this.mContext.getContentResolver(), "oem_screen_better_value", OPScreenColorMode.DEFAULT_COLOR_PROGRESS));
        this.mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.oneplus.settings.ui.OPSeekBarPreference.AnonymousClass1 */

            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                OPColorModeSeekBarChangeListener oPColorModeSeekBarChangeListener = OPSeekBarPreference.this.mOPColorModeSeekBarChangeListener;
