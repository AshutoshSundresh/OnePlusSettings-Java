...
public class OPScreenColorModePreference extends Preference {
    ...
    public OPScreenColorModePreference(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        initView(context);
    }

    public OPScreenColorModePreference(Context context, AttributeSet attributeSet) {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        ViewPager viewPager = (ViewPager) preferenceViewHolder.findViewById(C0010R$id.whatsnew_viewpager);
        ...
        AnonymousClass1 r7 = new PagerAdapter(this) {
            /* class com.oneplus.settings.ui.OPScreenColorModePreference.AnonymousClass1 */
    ...
    public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            OPScreenColorModePreference.this.currIndex = i;
        }

        @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
        public void onPageScrolled(int i, float f, int i2) {
            OPScreenColorModePreference.this.mPageIndicator.setLocation(((float) i) + f);
        }
    }
}
