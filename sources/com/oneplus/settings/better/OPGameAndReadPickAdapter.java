...
public class OPGameAndReadPickAdapter extends BaseAdapter {
    ...
    public OPGameAndReadPickAdapter(Context context, List<OPAppModel> list) {
        this.mAppList = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = this.mInflater.inflate(C0012R$layout.op_game_read_app_list_item, (ViewGroup) null);
    ...
    class ItemViewHolder {
        ...
        ItemViewHolder(OPGameAndReadPickAdapter oPGameAndReadPickAdapter) {
        }
    }
}
