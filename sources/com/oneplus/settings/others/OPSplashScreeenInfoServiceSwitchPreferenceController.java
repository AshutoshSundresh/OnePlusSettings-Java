...
public class OPSplashScreeenInfoServiceSwitchPreferenceController extends BasePreferenceController implements LifecycleObserver, OnResume, SwitchWidgetController.OnSwitchChangeListener {
    ...
    private static final String KEY_SPLASH_SCREEN_INFO_SERVICE = "splash_screen_info_service";
    private static final int KEY_SPLASH_SCREEN_INFO_SERVICE_TYPE = 13;
    ...
    public String getPreferenceKey() {
        return KEY_SPLASH_SCREEN_INFO_SERVICE;
    }
    ...
    public OPSplashScreeenInfoServiceSwitchPreferenceController(Context context) {
        super(context, KEY_SPLASH_SCREEN_INFO_SERVICE);
    }

    @Override // com.android.settingslib.core.AbstractPreferenceController, com.android.settings.core.BasePreferenceController
    public void displayPreference(PreferenceScreen preferenceScreen) {
        super.displayPreference(preferenceScreen);
        this.mSwitch = (MasterSwitchPreference) preferenceScreen.findPreference(KEY_SPLASH_SCREEN_INFO_SERVICE);
    }
    ...
    public void onResume() {
        if (isAvailable()) {
            try {
                ...
                boolean z = true;
                if (Settings.System.getInt(this.mContext.getContentResolver(), "oem_splash_ads_enable") != 1) {
                    z = false;
                }
    ...
    public boolean onSwitchToggled(boolean z) {
        Settings.System.putInt(this.mContext.getContentResolver(), "oem_splash_ads_enable", z ? 1 : 0);
        OPUtils.sendAnalytics("op_ads", "status", z ? "on" : "off");
        return true;
    }

    @Override // com.android.settingslib.core.AbstractPreferenceController, com.android.settings.core.BasePreferenceController
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (!KEY_SPLASH_SCREEN_INFO_SERVICE.equals(preference.getKey())) {
            return false;
        }
        Intent intent = new Intent(OPLEGAL_NOTICES_ACTION);
        intent.putExtra(KEY_NOTICES_TYPE, 13);
