...
public class OPUsvSystemUpdateController extends BasePreferenceController {
    ...
    public boolean isNeedAvailable() {
        return !this.mContext.getResources().getBoolean(C0005R$bool.config_use_gota) && ProductUtils.isUsvMode() && this.mUm.isAdminUser();
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (this.mUpdatePreference != null) {
            ...
            if (this.mUpdatePreference.getIntent() == null || this.mUpdatePreference.getIntent().resolveActivity(this.mContext.getPackageManager()) == null || (ProductUtils.isUsvMode() && resolveActivity == null)) {
