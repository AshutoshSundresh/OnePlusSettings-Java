            ...
            if (!(i == 47 || i == 61)) {
                ...
                if (i != 59) {
                    switch (i) {
                        ...
                        case R$styleable.Constraint_layout_constraintWidth_max /* 93 */:
                            return false;
                        case R$styleable.Constraint_layout_constraintWidth_default /* 92 */:
                            break;
                        default:
                            return true;
                    }
                ...
                for (int i3 = 0; i3 < 4; i3++) {
                    ...
                    if (b < 48 || b > 57) {
                        if (b >= 97 && b <= 102) {
                            ...
                            syntaxError("\\u" + this.buffer.readUtf8(4));
                            throw null;
                        } else {
                            i = b - 65;
                        }
