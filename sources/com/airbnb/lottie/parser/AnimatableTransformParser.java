...
public class AnimatableTransformParser {
    ...
    private static boolean isRotationIdentity(AnimatableFloatValue animatableFloatValue) {
        return animatableFloatValue == null || (animatableFloatValue.isStatic() && ((Keyframe) animatableFloatValue.getKeyframes().get(0)).startValue.floatValue() == 0.0f);
    }

    private static boolean isScaleIdentity(AnimatableScaleValue animatableScaleValue) {
        return animatableScaleValue == null || (animatableScaleValue.isStatic() && ((Keyframe) animatableScaleValue.getKeyframes().get(0)).startValue.equals(1.0f, 1.0f));
    }
