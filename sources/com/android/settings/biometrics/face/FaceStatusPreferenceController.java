...
public class FaceStatusPreferenceController extends BiometricStatusPreferenceController {
    ...
    public String getSummaryTextEnrolled() {
        return this.mContext.getResources().getString(C0017R$string.security_settings_face_preference_summary);
    }

    /* access modifiers changed from: protected */
    @Override // com.android.settings.biometrics.BiometricStatusPreferenceController
    public String getSummaryTextNoneEnrolled() {
        return this.mContext.getResources().getString(C0017R$string.security_settings_face_preference_summary_none);
    }
