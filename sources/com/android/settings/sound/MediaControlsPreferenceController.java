...
public class MediaControlsPreferenceController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "qs_media_resumption", 1) == 0;
    }
    ...
    public int getAvailabilityStatus() {
        return useQsMediaPlayer(this.mContext) ? 0 : 3;
    }

    protected static boolean useQsMediaPlayer(Context context) {
        return Settings.Global.getInt(context.getContentResolver(), "qs_media_player", 1) > 0;
    }
}
