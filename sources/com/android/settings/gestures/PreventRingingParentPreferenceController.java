...
public class PreventRingingParentPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (i2 == 1) {
            i = C0017R$string.prevent_ringing_option_vibrate_summary;
        } else if (i2 != 2) {
            i = C0017R$string.prevent_ringing_option_none_summary;
        } else {
            i = C0017R$string.prevent_ringing_option_mute_summary;
        }
