...
public class DeviceControlsPreferenceController extends GesturePreferenceController {
    @VisibleForTesting
    protected static final String ENABLED_SETTING = "controls_enabled";
    ...
    public DeviceControlsPreferenceController(Context context, String str) {
        super(context, str);
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        return this.mContext.getPackageManager().hasSystemFeature("android.software.controls") ? 0 : 2;
    }
    ...
    public boolean isChecked() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), ENABLED_SETTING, 1) == 1;
    }
}
