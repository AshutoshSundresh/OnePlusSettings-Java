            ...
            if (this.buf != null) {
                ...
                AnonymousClass1 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
                    ...
                    public String toString() {
                        ...
                        try {
                            return new String(((ByteArrayOutputStream) this).buf, 0, (i <= 0 || ((ByteArrayOutputStream) this).buf[i + -1] != 13) ? ((ByteArrayOutputStream) this).count : i - 1, StrictLineReader.this.charset.name());
