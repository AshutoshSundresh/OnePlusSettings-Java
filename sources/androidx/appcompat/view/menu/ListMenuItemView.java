...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    private static int DOUBLE_LIEN_HEIGHT = R$dimen.oneplus_menu_double_line_height;
    private static final int ICON_SIZE = R$dimen.oneplus_menu_icon_size;
    private static final int MARGIN_LEFT2 = R$dimen.oneplus_menu_margin_left2;
    private static final int MARGIN_LEFT4 = R$dimen.oneplus_menu_margin_left4;
