...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            imageView.saveAttributeDataForStyleable(imageView.getContext(), R$styleable.AppCompatImageView, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        }
        try {
