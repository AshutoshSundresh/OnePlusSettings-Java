...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private boolean mIsBottomAction;
    private int mMargin;
    private int mMargin0;
    ...
    public ActionMenuView(Context context, boolean z) {
        this(context, (AttributeSet) null);
        this.mIsBottomAction = z;
    }
    ...
    public ActionMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mPopupTheme = 0;
        this.mMargin0 = (int) (f * 10.0f);
        this.mMargin = context.getResources().getDimensionPixelSize(R$dimen.op_control_margin_space2);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.mFormatItems || childCount <= 0) {
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (this.mIsBottomAction) {
                    ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin = 0;
                    if (i3 == 0) {
                        ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin = this.mMargin0;
                    } else {
    ...
    public Menu getMenu(boolean z) {
        if (this.mMenu == null) {
            Context context = getContext();
            MenuBuilder menuBuilder = new MenuBuilder(context);
            this.mMenu = menuBuilder;
            menuBuilder.setCallback(new MenuBuilderCallback());
            ActionMenuPresenter actionMenuPresenter = new ActionMenuPresenter(context, z);
            this.mPresenter = actionMenuPresenter;
            actionMenuPresenter.setReserveOverflow(true);
            ActionMenuPresenter actionMenuPresenter2 = this.mPresenter;
            MenuPresenter.Callback callback = this.mActionMenuPresenterCallback;
