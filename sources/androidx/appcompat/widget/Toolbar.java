...
public class Toolbar extends ViewGroup {
    private final int MAX_NAVIGATION_BUTTON_HEIGHT;
    ...
    public Toolbar(Context context, AttributeSet attributeSet) {
        ...
        this.mPaddingTopOffset = (int) AppUtils.dpToPx(context, 8);
    }

    public Toolbar(Context context, AttributeSet attributeSet, int i, boolean z) {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.MAX_NAVIGATION_BUTTON_HEIGHT = getResources().getDimensionPixelOffset(R$dimen.op_toolbar_navigation_max_button_height);
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, R$styleable.Toolbar, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        }
    ...
    private void ensureMenu() {
        ...
        if (this.mMenuView.peekMenu() == null) {
            MenuBuilder menuBuilder = (MenuBuilder) this.mMenuView.getMenu(this.mIsBottomAppBar);
            if (this.mExpandedMenuPresenter == null) {
                this.mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
            }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ActionMenuView actionMenuView = new ActionMenuView(getContext(), this.mIsBottomAppBar);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            measureChildConstrained(this.mNavButtonView, i, 0, i2, 0, this.MAX_NAVIGATION_BUTTON_HEIGHT);
        ...
        int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(paddingTop, getSuggestedMinimumHeight()) - ((!NavigationButtonUtils.is3ButtonNavigationBar(getContext()) || !this.mIsBottomAppBar) ? 0 : (int) dpToPx(getContext(), 12)), i2, i9 << 16);
        if (!shouldCollapse()) {
    ...
    private int getChildTop(View view, int i) {
        ...
        if (childVerticalGravity == 48) {
            return (getPaddingTop() - i2) + (this.mPaddingTopOffset / 2);
        }
