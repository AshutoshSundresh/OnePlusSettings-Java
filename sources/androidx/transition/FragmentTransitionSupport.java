...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void setListenerForTransitionEnd(Fragment fragment, Object obj, CancellationSignal cancellationSignal, final Runnable runnable) {
        ...
        transition.addListener(new Transition.TransitionListener(this) {
            /* class androidx.transition.FragmentTransitionSupport.AnonymousClass5 */
    ...
    public void setEpicenter(Object obj, final Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback(this) {
                /* class androidx.transition.FragmentTransitionSupport.AnonymousClass6 */
