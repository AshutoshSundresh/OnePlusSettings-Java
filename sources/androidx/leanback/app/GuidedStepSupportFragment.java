...
public class GuidedStepSupportFragment extends Fragment implements GuidedActionAdapter.FocusListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        AnonymousClass1 r13 = new GuidedActionAdapter.EditListener() {
            /* class androidx.leanback.app.GuidedStepSupportFragment.AnonymousClass1 */
        ...
        this.mAdapter = new GuidedActionAdapter(this.mActions, new GuidedActionAdapter.ClickListener() {
            /* class androidx.leanback.app.GuidedStepSupportFragment.AnonymousClass2 */
        ...
        this.mButtonAdapter = new GuidedActionAdapter(this.mButtonActions, new GuidedActionAdapter.ClickListener() {
            /* class androidx.leanback.app.GuidedStepSupportFragment.AnonymousClass3 */
        ...
        this.mSubAdapter = new GuidedActionAdapter(null, new GuidedActionAdapter.ClickListener() {
            /* class androidx.leanback.app.GuidedStepSupportFragment.AnonymousClass4 */
