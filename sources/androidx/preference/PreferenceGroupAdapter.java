...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    private Runnable mSyncRunnable = new Runnable() {
        /* class androidx.preference.PreferenceGroupAdapter.AnonymousClass1 */
    ...
    public void updatePreferences() {
        ...
        if (preferenceManager == null || preferenceManager.getPreferenceComparisonCallback() == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback(this) {
                /* class androidx.preference.PreferenceGroupAdapter.AnonymousClass2 */
    ...
    private ExpandButton createExpandButton(final PreferenceGroup preferenceGroup, List<Preference> list) {
        ...
        expandButton.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            /* class androidx.preference.PreferenceGroupAdapter.AnonymousClass3 */
