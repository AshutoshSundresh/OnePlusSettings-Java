        ...
        try {
            if (getActivity() != null) {
                getActivity().runOnUiThread(new Runnable() {
                    /* class androidx.preference.PreferenceDialogFragmentCompat.AnonymousClass1 */

                    public void run() {
                        if (PreferenceDialogFragmentCompat.this.dialog != null && PreferenceDialogFragmentCompat.this.dialog.isShowing()) {
                            PreferenceDialogFragmentCompat.this.dialog.setCancelMessage(null);
                            PreferenceDialogFragmentCompat.this.dialog.setOnCancelListener(null);
                            PreferenceDialogFragmentCompat.this.dialog.setOnDestory();
                            PreferenceDialogFragmentCompat.this.dialog.dismiss();
                            PreferenceDialogFragmentCompat.this.dialog = null;
                        }
                    }
                });
            }
