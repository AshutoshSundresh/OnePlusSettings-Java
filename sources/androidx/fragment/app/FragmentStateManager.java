...
public class FragmentStateManager {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = androidx.fragment.app.FragmentStateManager.AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = androidx.fragment.app.FragmentStateManager.AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            if (view != null) {
                ...
                if (ViewCompat.isAttachedToWindow(this.mFragment.mView)) {
                    ...
                    view2.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener(this) {
                        /* class androidx.fragment.app.FragmentStateManager.AnonymousClass1 */
